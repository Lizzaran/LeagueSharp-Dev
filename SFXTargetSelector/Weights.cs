    ...
    public static class Weights
    {
        ...
        static Weights()
        {
            ...
            Items = new HashSet<Item>
            {
                ...
                new Item(
                    ...
                    t =>
                        (t.MinionsKilled + t.NeutralMinionsKilled) * 27.35f + t.ChampionsKilled * 300f + t.Assists * 85f),
                new Item(
        ...
        internal static void AddToMenu(Menu mainMenu, Menu drawingMenu)
        {
            ...
            drawingWeightsGroupMenu.AddItem(
                new MenuItem(drawingWeightsGroupMenu.Name + ".color", "Color").SetShared().SetValue(Color.SpringGreen));
            drawingWeightsGroupMenu.AddItem(
                new MenuItem(drawingWeightsGroupMenu.Name + ".radius", "Radius").SetShared().SetValue(new Slider(55)));
            drawingWeightsGroupMenu.AddItem(
        ...
        private static void OnDrawingDraw(EventArgs args)
        {
            ...
            var circleThickness = _mainMenu.Item(_mainMenu.Name + ".drawing.circle-thickness").GetValue<Slider>().Value;
