...
/*
 ...
 Blowfish.cs is part of SFXUtility.
...
namespace SFXUtility.Classes
{
    ...
    internal class Blowfish
    {
        ...
        //standard is 16, to increase the number of rounds, bf_P needs to be equal to the number of rounds. Use digits of PI.
        ...
        /// </exception>
        /// <exception cref="Exception">IV not set.</exception>
        ...
        /// <exception cref="Exception">Invalid IV size.</exception>
        /// <exception cref="OverflowException">Condition. </exception>
        ...
        /// </summary>
        /// <exception cref="Exception" accessor="set">Invalid IV size.</exception>
        /// <exception cref="OverflowException">Condition. </exception>
