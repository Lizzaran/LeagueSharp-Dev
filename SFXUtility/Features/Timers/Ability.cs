    ...
    internal class Ability : Child<Timers>
    {
        ...
        protected override void OnInitialize()
        {
            ...
            _abilities = new Dictionary<string, AbilityItem>
            {
                ...
                { "yasuo_base_w_windwall_enemy_01.troy", new AbilityItem("yasuo", "W1 " + Global.Lang.Get("G_Enemy"), 4f) },
                { "yasuo_base_w_windwall_enemy_02.troy", new AbilityItem("yasuo", "W2 " + Global.Lang.Get("G_Enemy"), 4f) },
                { "yasuo_base_w_windwall_enemy_03.troy", new AbilityItem("yasuo", "W3 " + Global.Lang.Get("G_Enemy"), 4f) },
                { "yasuo_base_w_windwall_enemy_04.troy", new AbilityItem("yasuo", "W4 " + Global.Lang.Get("G_Enemy"), 4f) },
                { "yasuo_base_w_windwall_enemy_05.troy", new AbilityItem("yasuo", "W5 " + Global.Lang.Get("G_Enemy"), 4f) },
